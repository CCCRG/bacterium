...
также нужно доработать Bisection1.py, чтобы она расчитывал корреляцию сразу для трех вариантов:
- для текущего диапазона датчика x
- для первой секции после уменьшения текущей секции
- для второй секции после уменьшения текущей секции
